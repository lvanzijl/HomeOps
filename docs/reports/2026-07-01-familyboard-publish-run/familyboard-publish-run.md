...
Publish mode completed successfully. A timestamped FamilyBoard MP4 was retained in `docs/demo/`, metadata and timing JSON were generated, cleanup completed, and the Marketing Production Engine handled the full run.
...
`/home/runner/work/HomeOps/HomeOps/docs/demo/familyboard-preview-20260701-175453.mp4`
...
- `docs/demo/familyboard-preview-20260701-175453.mp4`
