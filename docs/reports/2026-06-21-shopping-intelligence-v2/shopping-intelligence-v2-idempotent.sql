...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260620221320_AddShoppingIntelligenceFoundation') THEN
    ALTER TABLE "ListItems" ADD "PreferredStore" character varying(120);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260620221320_AddShoppingIntelligenceFoundation') THEN
    CREATE TABLE "ShoppingItemPreferences" (
        "Id" uuid NOT NULL,
        "HouseholdId" uuid NOT NULL,
        "NormalizedText" character varying(240) NOT NULL,
        "ItemText" character varying(240) NOT NULL,
        "PreferredStore" character varying(120) NOT NULL,
        "StoreObservationCount" integer NOT NULL,
        "CreatedUtc" timestamp with time zone NOT NULL,
        "UpdatedUtc" timestamp with time zone NOT NULL,
        CONSTRAINT "PK_ShoppingItemPreferences" PRIMARY KEY ("Id")
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260620221320_AddShoppingIntelligenceFoundation') THEN
    UPDATE "ListItems" SET "PreferredStore" = NULL
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260620221320_AddShoppingIntelligenceFoundation') THEN
    CREATE UNIQUE INDEX "IX_ShoppingItemPreferences_HouseholdId_NormalizedText" ON "ShoppingItemPreferences" ("HouseholdId", "NormalizedText");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260620221320_AddShoppingIntelligenceFoundation') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260620221320_AddShoppingIntelligenceFoundation', '10.0.4');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621051015_AddCelebrationMemory') THEN
    ALTER TABLE "MotivationFamilyGoals" ADD "CelebrationCelebratedUtc" timestamp with time zone;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621051015_AddCelebrationMemory') THEN
    UPDATE "MotivationFamilyGoals" SET "CelebrationCelebratedUtc" = NULL
    WHERE "Id" = '8e7e795f-66cf-4c18-87cf-1d33d1b81f01';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621051015_AddCelebrationMemory') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260621051015_AddCelebrationMemory', '10.0.4');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621083841_AddRecurringTaskHygiene') THEN
    DROP INDEX "IX_HouseholdTasks_HouseholdId_IsCompleted_DueDate";
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621083841_AddRecurringTaskHygiene') THEN
    ALTER TABLE "HouseholdTasks" ADD "IsExpired" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621083841_AddRecurringTaskHygiene') THEN
    CREATE INDEX "IX_HouseholdTasks_HouseholdId_IsCompleted_IsExpired_DueDate" ON "HouseholdTasks" ("HouseholdId", "IsCompleted", "IsExpired", "DueDate");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621083841_AddRecurringTaskHygiene') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260621083841_AddRecurringTaskHygiene', '10.0.4');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621104619_AddGoalHygiene') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621104619_AddGoalHygiene') THEN
    CREATE UNIQUE INDEX "IX_MotivationIndividualGoals_HouseholdId_FamilyMemberId" ON "MotivationIndividualGoals" ("HouseholdId", "FamilyMemberId") WHERE "IsActive";
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621104619_AddGoalHygiene') THEN
    CREATE UNIQUE INDEX "IX_MotivationFamilyGoals_HouseholdId" ON "MotivationFamilyGoals" ("HouseholdId") WHERE "IsActive";
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621104619_AddGoalHygiene') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260621104619_AddGoalHygiene', '10.0.4');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621111654_AddShoppingLifecycle') THEN
    DROP INDEX "IX_ListItems_ListId_CreatedUtc";
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621111654_AddShoppingLifecycle') THEN
    ALTER TABLE "Lists" ADD "ArchivedUtc" timestamp with time zone;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621111654_AddShoppingLifecycle') THEN
    ALTER TABLE "Lists" ADD "DeletedUtc" timestamp with time zone;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621111654_AddShoppingLifecycle') THEN
    ALTER TABLE "Lists" ADD "IsArchived" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621111654_AddShoppingLifecycle') THEN
    ALTER TABLE "Lists" ADD "IsDeleted" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621111654_AddShoppingLifecycle') THEN
    ALTER TABLE "ListItems" ADD "CompletedUtc" timestamp with time zone;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621111654_AddShoppingLifecycle') THEN
    ALTER TABLE "ListItems" ADD "DeletedUtc" timestamp with time zone;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621111654_AddShoppingLifecycle') THEN
    ALTER TABLE "ListItems" ADD "IsDeleted" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621111654_AddShoppingLifecycle') THEN
    UPDATE "ListItems" SET "CompletedUtc" = NULL, "DeletedUtc" = NULL, "IsDeleted" = FALSE
    WHERE "Id" = '44444444-4444-4444-4444-444444444444';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621111654_AddShoppingLifecycle') THEN
    UPDATE "Lists" SET "ArchivedUtc" = NULL, "DeletedUtc" = NULL, "IsArchived" = FALSE, "IsDeleted" = FALSE
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621111654_AddShoppingLifecycle') THEN
    CREATE INDEX "IX_ListItems_ListId_IsDeleted_IsCompleted_CreatedUtc" ON "ListItems" ("ListId", "IsDeleted", "IsCompleted", "CreatedUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621111654_AddShoppingLifecycle') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260621111654_AddShoppingLifecycle', '10.0.4');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621154325_AddNoDateTaskLifecycle') THEN
    ALTER TABLE "HouseholdTasks" ADD "ArchivedUtc" timestamp with time zone;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621154325_AddNoDateTaskLifecycle') THEN
    ALTER TABLE "HouseholdTasks" ADD "NoDateLastReviewedUtc" timestamp with time zone;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621154325_AddNoDateTaskLifecycle') THEN
    ALTER TABLE "HouseholdTasks" ADD "NoDateReviewState" character varying(24) NOT NULL DEFAULT 'Active';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621154325_AddNoDateTaskLifecycle') THEN
    CREATE INDEX "IX_HouseholdTasks_HouseholdId_NoDateReviewState_DueDate_Create~" ON "HouseholdTasks" ("HouseholdId", "NoDateReviewState", "DueDate", "CreatedUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621154325_AddNoDateTaskLifecycle') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260621154325_AddNoDateTaskLifecycle', '10.0.4');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621165157_AddShoppingPurchaseHistory') THEN
    CREATE TABLE "ShoppingPurchaseHistories" (
        "Id" uuid NOT NULL,
        "HouseholdId" uuid NOT NULL,
        "NormalizedText" character varying(240) NOT NULL,
        "ItemText" character varying(240) NOT NULL,
        "Store" character varying(120) NOT NULL,
        "PurchaseCount" integer NOT NULL,
        "CreatedUtc" timestamp with time zone NOT NULL,
        "UpdatedUtc" timestamp with time zone NOT NULL,
        CONSTRAINT "PK_ShoppingPurchaseHistories" PRIMARY KEY ("Id")
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621165157_AddShoppingPurchaseHistory') THEN
    CREATE INDEX "IX_ShoppingPurchaseHistories_HouseholdId_NormalizedText_Purcha~" ON "ShoppingPurchaseHistories" ("HouseholdId", "NormalizedText", "PurchaseCount");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621165157_AddShoppingPurchaseHistory') THEN
    CREATE UNIQUE INDEX "IX_ShoppingPurchaseHistories_HouseholdId_NormalizedText_Store" ON "ShoppingPurchaseHistories" ("HouseholdId", "NormalizedText", "Store");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621165157_AddShoppingPurchaseHistory') THEN
    DROP TABLE "ShoppingItemPreferences";
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621165157_AddShoppingPurchaseHistory') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260621165157_AddShoppingPurchaseHistory', '10.0.4');
    END IF;
END $EF$;
COMMIT;
