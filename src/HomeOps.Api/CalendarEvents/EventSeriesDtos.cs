...
public sealed record CreateEventSeriesRequest(string Title, string? Description, string? Location, DateTimeOffset StartUtc, DateTimeOffset? EndUtc, bool IsAllDay, RecurrenceRuleDto? RecurrenceRule = null, Lists.DecorativeAvatarReferenceDto? DecorativeAvatar = null);

public sealed record UpdateEventSeriesRequest(string Title, string? Description, string? Location, DateTimeOffset StartUtc, DateTimeOffset? EndUtc, bool IsAllDay, RecurrenceRuleDto? RecurrenceRule = null, Lists.DecorativeAvatarReferenceDto? DecorativeAvatar = null);
