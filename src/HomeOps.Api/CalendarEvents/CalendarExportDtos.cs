...
public sealed record CalendarExportClimateProvider(Guid Id, string DisplayName, string ProviderType, bool IsEnabled, bool IsArchived, DateTimeOffset? ArchivedUtc, string? ExternalInstanceReference, string? DiagnosticMetadata, DateTimeOffset CreatedUtc, DateTimeOffset UpdatedUtc, string? HomeAssistantResumeStrategyType = null, string? HomeAssistantResumeScriptEntityReference = null, string? HomeAssistantResumeClimateEntityReference = null, string? HomeAssistantResumePresetValue = null, DateTimeOffset? HomeAssistantResumeStrategyUpdatedUtc = null);
