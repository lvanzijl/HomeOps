...
internal static class MarketingHouseholdFixtureBuilder
{
    ...
    private static void AddCalendarSource(HomeOpsDbContext db, DateTimeOffset anchorUtc) => db.EventSources.Add(new() { Id = CalendarSourceId, HouseholdId = SeedHousehold.Id, Name = "Van Zijl Family Calendar", SourceType = EventSourceTypes.Manual, IsWritable = true, IsSystem = true, CreatedUtc = anchorUtc, UpdatedUtc = anchorUtc });
