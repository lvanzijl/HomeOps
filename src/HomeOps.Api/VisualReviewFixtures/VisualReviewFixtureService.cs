...
public static class VisualReviewFixtureService
{
    ...
    private static void AddCalendarSource(HomeOpsDbContext db) => db.EventSources.Add(new() { Id = CalendarSourceId, HouseholdId = SeedHousehold.Id, Name = "Visual Review Calendar", SourceType = EventSourceTypes.Manual, IsWritable = true, IsSystem = true, CreatedUtc = AnchorUtc, UpdatedUtc = AnchorUtc });
