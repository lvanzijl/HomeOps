...
public sealed record OnboardingStatusDto(bool OnboardingCompleted, bool HasActiveFamilyMembers, bool RequiresOnboarding, SetupChecklistDto? SetupChecklist);
