...
public sealed record OnboardingStatusDto(bool OnboardingCompleted, bool HasActiveFamilyMembers, bool RequiresOnboarding, string TimeZoneId, SetupChecklistDto? SetupChecklist);

public sealed record SetupChecklistDto(
    bool IsDismissed,
    bool WeatherLocationConfigured,
    bool FirstListConfigured,
    bool CalendarSourceConfigured,
