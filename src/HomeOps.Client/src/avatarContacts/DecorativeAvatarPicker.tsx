...
import { buildDecorativeAvatarSuggestionCandidates, rankDecorativeAvatarSuggestions } from './decorativeAvatarSuggestions';
...
export function DecorativeAvatarPicker({ familyMembers, knownPeople, label, onChange, suggestionText, value }: DecorativeAvatarPickerProps) {
...
export function parseDecorativeAvatarPickerValue(value: string): DecorativeAvatarReference | null {
...
export function resolveDecorativeAvatar(reference: DecorativeAvatarReference | null | undefined, familyMembers: readonly FamilyMember[], knownPeople: readonly KnownPerson[]): DecorativeAvatarIdentity | null {
