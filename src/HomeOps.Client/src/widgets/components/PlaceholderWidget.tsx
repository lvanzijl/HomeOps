...
export function PlaceholderWidget({ definition, instance }: WidgetRenderProps) {
  const body = String(instance.settings.body ?? definition.settings.body ?? 'Hier is straks meer ruimte voor je gezin.');

  return (
    <article className="widget-card" aria-label={instance.title}>
      <p className="widget-type">Binnenkort beschikbaar</p>
