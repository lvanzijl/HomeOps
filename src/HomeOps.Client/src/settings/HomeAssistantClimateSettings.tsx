...
function ProviderForm({ provider, busy, onCancel, onSave }: { provider: ClimateProvider | null; busy: boolean; onCancel: () => void; onSave: (name: string, url: string, enabled: boolean) => Promise<void> }) {
