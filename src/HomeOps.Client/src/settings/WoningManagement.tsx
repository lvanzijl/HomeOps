...
interface RoomCardProps { room: Room; config?: RoomClimateConfiguration | null; busy: boolean; onEdit: () => void; onMove: () => void; onArchive: () => void; onDelete: () => void; onTop: () => void; onUp: () => void; onDown: () => void; onBottom: () => void; }
...
interface ArchivedProps { title: string; children: ReactNode; }
...
function Archived({ title, children }: ArchivedProps) { return <section className="woning-archived" aria-label={title}><h5>{title}</h5>{children}</section>; }
