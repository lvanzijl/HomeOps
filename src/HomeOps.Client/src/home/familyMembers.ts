...
export const familyMembers: readonly FamilyMember[] = [
  { id: 'alex', name: 'Alex', displayColor: '#f8c8dc', initials: 'A', memberKind: 'adult', dateOfBirth: null, avatar: { ageGroup: 'adult', presentation: 'feminine', skinTone: '#c68642', hairColor: '#3b2416', hairStyle: 'long', glasses: false, shirtColor: '#f472b6' } },
  { id: 'sam', name: 'Sam', displayColor: '#c7d2fe', initials: 'S', memberKind: 'adult', dateOfBirth: null, avatar: { ageGroup: 'adult', presentation: 'masculine', skinTone: '#f1c27d', hairColor: '#4b5563', hairStyle: 'short', glasses: true, shirtColor: '#60a5fa' } },
  { id: 'riley', name: 'Riley', displayColor: '#bbf7d0', initials: 'R', memberKind: 'child', dateOfBirth: '2018-04-12', avatar: { ageGroup: 'child', presentation: 'neutral', skinTone: '#8d5524', hairColor: '#111827', hairStyle: 'curly', glasses: false, shirtColor: '#34d399' } },
  { id: 'jordan', name: 'Jordan', displayColor: '#fde68a', initials: 'J', memberKind: 'child', dateOfBirth: '2020-09-03', avatar: { ageGroup: 'child', presentation: 'neutral', skinTone: '#ffdbac', hairColor: '#92400e', hairStyle: 'top', glasses: true, shirtColor: '#fbbf24' } },
] as const;
